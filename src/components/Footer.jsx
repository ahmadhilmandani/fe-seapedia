          ...
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              <a class="flex items-center">
                <img src={SeaLogo} class="h-8 me-3" alt="FlowBite Logo" />
                <span class="self-center text-xl font-mono whitespace-nowrap tracking-wide">SEAPEADIA</span>
              </a>
            </div>
            <div class="grid grid-cols-2 gap-6 md:gap-12 xl:gap-24 sm:grid-cols-3">
              <div>
                ...
                <ul class=" font-medium">
                  ...
                  <li class="mb-4">
                    <a class="hover:underline">Product</a>
                  </li>
                  <li class="mb-4">
              ...
              <div>
                ...
                <ul class=" font-medium">
                  <li class="mb-4">
                    <a href="#" class="hover:underline">Dave</a>
                  </li>
                  <li class="mb-4">
                    <a href="#" class="hover:underline">Bena</a>
                  </li>
                </ul>
              </div>
            </div>
